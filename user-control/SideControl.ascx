<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SideControl.ascx.cs" Inherits="user_control_SideControl" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
             <asp:Label ID="lblLeadCategory" style="padding:4px" runat="server" Text=""></asp:Label>
    <div  class="side-contact" >
        <div >
            <asp:Label ID="lblFormHeading" runat="server" Text=""></asp:Label>
 </div>
 <ul id="lstofall-sidecontact">    <li >
...
<asp:RegularExpressionValidator ID="rgv_phone_vaidation" runat="server" ValidationGroup="CenterFormValidation"
              ...
              <li>
               <asp:TextBox ID="txt_comm"  TextMode="MultiLine" CssClass="bar"  placeholder="Comment"  runat="server"></asp:TextBox>
                </li>
     ...
     <li>   <asp:Button ID="btn_submit"  CssClass="bar-submit"  runat="server" Text="SUBMIT" ValidationGroup="CenterFormValidation"
