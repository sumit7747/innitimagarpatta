...
public partial class user_control_Contact : System.Web.UI.UserControl
{
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            //string remoteUrl = "http://localhost:2531/Default2.aspx";
             if (ctrlGoogleReCaptcha.IsValid)
        {
    ...
    Recaptcha.RecaptchaControl ctrlGoogleReCaptcha = new Recaptcha.RecaptchaControl();
    //Recaptcha.Recaptcha ctrlGoogleReCaptcha = new Recaptcha.Recaptcha();
