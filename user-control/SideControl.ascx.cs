...
public partial class user_control_SideControl : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string lastSegment = path.Substring(pos, path.Length - pos);

            if (path.Contains("http://www.innitialliance.com/resource/claims-processing"))
            {

                Response.Write(lastSegment);
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ctrlGoogleReCaptcha001.Validate())
            {
                ...
                SendMail("info@innitialliance", txt_email.Text, "", BCCThanx, "Thank you for contacting Inniti", mailbody);
                ...
                {
                    Response.Write(path);
                    Response.Redirect("http://www.innitialliance.com/resources/" + lastSegment+".pdf");
