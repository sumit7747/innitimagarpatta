<%@ Page Language="C#" AutoEventWireup="true" CodeFile="claims-processing122016.aspx.cs" Inherits="mailer_campaigns_dec_landing" %>
...
<body>
  ...
  <div class="container main">
        ...
        <div class="row banner">
        	<img src="/images/inniti-dec.jpg" alt="claims process"  border="0" usemap="#Map"  class="img-responsive"/>
        	<map name="Map">
              <area shape="rect" coords="95,19,862,381" href="http://www.innitialliance.com/claims-management.aspx" target="_blank" alt="Claims Process">
            </map>
        </div>
...
further growth.</p>
<p><b>Key Benefits of aligning with Inniti for Insurance <a href="http://www.innitialliance.com/claims-processing.aspx"><u>Claims Processing</u></a></b></p>
<ul>
