...
public partial class Backend_add_page_bussiness_process_backend : System.Web.UI.Page
{
    ...
    protected void Submit(object sender, EventArgs e)
    {
        ...
        string query = "INSERT INTO  Inniti_backend_MainPageBP (UrlTitle,PageName,SeoDescription,SeoKeyword,BannerImage,MainHeading,MainContent,InternalLinks,TagLine,Category,RelatedPage,created_date) VALUES (@UrlTitle,@PageName,@SeoDescription,@SeoKeyword,@BannerImage,@MainHeading,@MainContent,@InternalLinks,@TagLine,@Category,@RelatedPage,@created_date)";
