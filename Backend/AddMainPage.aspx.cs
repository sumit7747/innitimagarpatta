...
public partial class Backend_AddMainPage : System.Web.UI.Page
{
    ...
    protected void Submit(object sender, EventArgs e)
    {
        ...
        string query = "INSERT INTO  dbo.Inniti_Main (PageName,desc_seo,Title,Mail_Content,created_date) VALUES (@PageName,@desc_seo,@Title, @Mail_Content,@created_date)";
