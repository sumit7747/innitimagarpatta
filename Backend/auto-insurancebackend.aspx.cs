...
public partial class Backend_auto_insurancebackend : System.Web.UI.Page
...

{
    ...
    private void PopulatePage()
    {
        ...
        string query = "SELECT UrlTitle,[PageName],SeoDescription,SeoKeyword,BannerImage,MainHeading,MainContent,InternalLinks,TagLine,Category,RelatedPage FROM Inniti_backend_MainPageAuto WHERE [PageName] = @PageName";
        string strConnection = ConfigurationManager.ConnectionStrings["strings"].ConnectionString;
