<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DynamicArticle.aspx.cs" Inherits="Backend_DynamicArticle" %>
    ...
    margin: 7px -9px;
                    ...
                    <div class="modal-header">
                        ...
                        <h4 style="padding: 29px; text-align: center; font-size: 22px;" class="modal-title">
                            Subscribe to our Article Via Email</h4>
                    </div>
