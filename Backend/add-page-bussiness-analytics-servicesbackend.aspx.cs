...
public partial class add_page_bussiness_analytics_servicesbackend : System.Web.UI.Page
{
    ...
    protected void Submit(object sender, EventArgs e)
    {
        ...
        string query = "INSERT INTO  Inniti_backend_MainPageBa (UrlTitle,PageName,SeoDescription,SeoKeyword,BannerImage,MainHeading,MainContent,InternalLinks,TagLine,Category,RelatedPage,created_date) VALUES (@UrlTitle,@PageName,@SeoDescription,@SeoKeyword,@BannerImage,@MainHeading,@MainContent,@InternalLinks,@TagLine,@Category,@RelatedPage,@created_date)";
