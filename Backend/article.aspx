<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="article.aspx.cs" Inherits="Backend_article" %>
...
<ItemTemplate>
    ...
    <%--<asp:HyperLink ID="HyperLink2" NavigateUrl='<%# Eval("PageName", "~/Pages/{0}.aspx") %>' Text='<%# Eval("Title") %>'--%>
            <asp:HyperLink NavigateUrl='<%# Eval("PageName", "~/article/{0}.aspx") %>' Text='<%# Eval("Title") %>'
