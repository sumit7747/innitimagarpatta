...
public partial class Backend_claims_managementbackend_aspx : System.Web.UI.Page
{
    ...
    private void PopulatePage()
    {
        ...
        string query = "SELECT UrlTitle,[PageName],SeoDescription,SeoKeyword,BannerImage,MainHeading,MainContent,InternalLinks,TagLine,Category,RelatedPage FROM Inniti_backend_MainPageCm WHERE [PageName] = @PageName";
        string strConnection = ConfigurationManager.ConnectionStrings["strings"].ConnectionString;
