...
public partial class Backend_business_intelligence_analyticsbackend : System.Web.UI.Page
{
    ...
    private void PopulatePage()
    {
        ...
        string query = "SELECT UrlTitle,[PageName],SeoDescription,SeoKeyword,BannerImage,MainHeading,MainContent,InternalLinks,TagLine,Category,RelatedPage FROM Inniti_backend_MainPageBa WHERE [PageName] = @PageName";
        string strConnection = ConfigurationManager.ConnectionStrings["strings"].ConnectionString;
