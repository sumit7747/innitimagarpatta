...
public partial class Backend_Main : System.Web.UI.Page
{
    ...
    private void PopulatePage()
    {
        ...
        string query = "SELECT [Title],[PageName], Mail_Content FROM Inniti_Main WHERE [PageName] = @PageName";
        string strConnection = ConfigurationManager.ConnectionStrings["strings"].ConnectionString;
            ...
            using (SqlCommand cmd = new SqlCommand(query))
            {
                using (SqlDataAdapter sda = new SqlDataAdapter())
                {
                    ...
                    using (DataTable dt = new DataTable())
                    {
                        ...
                        inner_content2.InnerHtml = dt.Rows[0]["Mail_Content2"].ToString();
